/*!
 * jQuery Slider Reboot - a simple jQuery slider code with some fancy parallax action
 * version: 0.1
 */

;(function ($, window, document, undefined) {

  $.fn.sliderreboot = function(params) {
    var params = $.extend({}, $.fn.sliderreboot.options, params);
    return new SliderReboot(this, params);
  };

  $.fn.sliderreboot.options = {
    currentSlide: 0,
    slideSpeed: 1000,
    slideMovement: 150,
  ...
  var SliderReboot = function (element, params) {
  ...
  SliderReboot.prototype = {
    ...
    _initPaginationListeners: function () {
      ...
      $(this.params.controlsSelector).each(function() {
        $(this).bind("click.sliderreboot", function(e) {
          e.preventDefault();
    ...
    _initMobileListeners: function() {
      ...
      this.element.bind("swipeleft.sliderreboot", function(e) {
        self.slideSetAndMove("toLeft");
       });

      this.element.bind("swiperight.sliderreboot", function (e) {
    ...
    _initKeyboardListeners: function() {
      var self = this;
      $("body").bind("keydown.sliderreboot", function(e) {
        if (e.keyCode === 37) {
          self.slideSetAndMove("toRight");
    ...
    _initWindowListeners: function() {
      ...
      $(window).bind("resize.sliderreboot", function() {
